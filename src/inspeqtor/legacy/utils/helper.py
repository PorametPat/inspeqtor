...
def pick_initial_state(initial_state: str) -> typing.Callable:
...
def pick_observable(observable: str) -> typing.Callable:
...
def pick_initial_state_and_observable(
    initial_state: str, observable: str
) -> typing.Callable:
...
def get_index(
    exp_vals: list[ExpectationValue], conditions=list[typing.Callable]
) -> list[int]:
    return [
        i
